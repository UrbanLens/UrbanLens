...
urlpatterns = [
	...
	path('map/', include([
		path('', map.MapController.as_view(), name='view_map'),
		path('init/', map.MapController.as_view(), name='init_map'),
		path('add/', map.MapController.as_view(), name='add_pin'),
		path('edit/<int:pin_id>/', map.MapController.as_view(), name='edit_pin'),
		path('search/', map.MapController.as_view(), name='search_pins'),
		path('upload_image/<int:location_id>/', map.MapController.as_view(), name='upload_image'),
		path('change_category/<int:location_id>/', map.MapController.as_view(), name='change_category'),
