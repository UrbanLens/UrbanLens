...
_CORE_URLPATTERNS: list[URLPattern] = [
    ...
    path("trips/<slug:trip_slug>/invitations/", views.TripInvitationsView.as_view(), name="trips.invitations"),
    path("trips/<slug:trip_slug>/invitations/<uuid:invitation_uuid>/", views.TripInvitationDetailView.as_view(), name="trips.invitations.detail"),
