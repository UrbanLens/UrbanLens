# dashboard/services/consensus/ — Goals (from docs/GOALS.md)
...
- Store gameplay-derived data in a schema general enough to support future/different analysis
  approaches, not just whatever ML pipeline is in use today — Consensus's Beta-Bernoulli trust
  model specifically should not be assumed to be the permanent shape of this data.
