...
# Trailing punctuation is excluded from the match itself (a URL at the end of a sentence shouldn't
# swallow its own period), and no <>"' - those either close an HTML attribute/tag or would already
# have been caught by the <a>/ <img> patterns above.
