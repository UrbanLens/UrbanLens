...
#: The reactions a trip (or pin, or wiki) comment may carry. Canonical here
#: rather than in ``controllers.comments`` so the external API's serializers
#: can bound their ``emoji`` field without importing a controller.
ALLOWED_COMMENT_EMOJIS = frozenset({"👍", "👎", "❤️", "😂", "😮", "😢", "🔥", "🏚️"})
