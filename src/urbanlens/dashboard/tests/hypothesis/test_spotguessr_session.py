...
class SubmitGuessTests(TestCase):
    ...
    def test_a_rejected_duplicate_guess_does_not_record_extra_coordinate_evidence(self) -> None:
        """Reachable via any client retry or resend, no special privilege required, and it silently pollutes the confidence-ranked evidence a real fact-sourcing pipeline reads."""
        from urbanlens.dashboard.models.spotguessr.model import PhotoCoordinateGuess
