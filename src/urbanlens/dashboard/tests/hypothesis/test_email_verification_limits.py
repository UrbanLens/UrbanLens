...
class EmailVerificationLimitTests(TestCase):
    ...
    def _add(self, address: str):
        with mock.patch("urbanlens.dashboard.services.auth.email_claims.queue_confirmation") as send:
    ...
    def test_an_exhausted_ledger_blocks_the_add_send(self) -> None:
        with (
            mock.patch("urbanlens.dashboard.services.auth.email_claims.queue_confirmation") as send,
            mock.patch(
