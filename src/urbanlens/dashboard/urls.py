                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path("<slug:pin_slug>/article/edit/", article.ArticleEditorView.as_view(), name="pin.article.edit"),
    ...
    path(
        ...
        include(
            [
                ...
                path("<slug:location_slug>/wiki/article/edit/", article.ArticleEditorView.as_view(), name="location.wiki.article.edit"),
