/**
 * Color swatch picker shared by categories/tags/organize's create and bulk-edit dialogs.
 */
...
export function resetColorPicker(pickerId: string, valueId: string): void {
    ...
    // Deliberately silent, unlike pickColor: this is a programmatic form reset, not somebody choosing a colour, and anything listening.
    const value = document.getElementById(valueId) as HTMLInputElement | null;
