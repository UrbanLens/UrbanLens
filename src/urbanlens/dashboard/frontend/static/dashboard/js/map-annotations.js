...
function init() {
  ...
  if (cfg.openweathermapApiKey) {
    const rainLayer = L.tileLayer(`https://tile.openweathermap.org/map/{layer}/{z}/{x}/{y}.png?appid=${cfg.openweathermapApiKey}`, { layer: "precipitation_new", opacity: 0.7, attribution: "&copy; OpenWeatherMap" });
    const cloudLayer = L.tileLayer(`https://tile.openweathermap.org/map/{layer}/{z}/{x}/{y}.png?appid=${cfg.openweathermapApiKey}`, { layer: "clouds_new", opacity: 0.5, attribution: "&copy; OpenWeatherMap" });
