# dashboard/models/trips/ — Goals (from docs/GOALS.md)

## Privacy model — trip activities

- Any shared surfaces, such as trips, source content from the associated Wiki, never directly
  from a pin. Single-user modes are the only exception — a user seeing their own pin data
  doesn't violate consent, since nothing is shared.
