...
class NotificationType(TextChoices):
    ...
    SAFETY_CHECKIN_DUE = "safety_checkin_due", "Safety Check-in Due"
    SAFETY_CHECKIN_OVERDUE = "safety_checkin_overdue", "Safety Check-in Overdue"
    SAFETY_CHECKIN_RESOLVED = "safety_checkin_resolved", "Safety Check-in Resolved"
    ERROR = "error", "Error"
