...
External integrations (third-party APIs and the features built on them) are packaged as plugins so individual installs can add, remove, and disable them independently."""
