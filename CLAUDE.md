...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. It was generated by an LLM, so it is a living document that may contain inaccuracies, outdated information, or incomplete sections. When in doubt, verify against the actual codebase and project documentation.
