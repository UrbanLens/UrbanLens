...
## P149 — Google sign-in identifies an account by its email address, so whoever holds that address at Google later signs in as its owner

`id: P149` · `status: open` · `updated: 2026-09-24`
