...
Clients: browsers → agent (sessions, unchanged UX). Future desktop/mobile → agent /api/v1/ growing from dashboard/external_api/ + docs/archive/external_app_api_plan.md. Agents → server /api/agent/v1/.
Data ownership map
