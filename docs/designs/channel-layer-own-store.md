# D22 — The Channels layer gets its own small Dragonfly, because the shared store refuses writes once full and a refused `group_send` is a live message nobody receives
...
`id: D22` · `status: accepted` · `updated: 2026-09-24`
