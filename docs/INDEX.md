...
| X28 | holds | 2026-09-21 | 1,000 concurrent users demand ~4.0 app cores against a 4-core limit, so p95 goes from 231 ms at 500 users to 6.2 s with nothing failing; the database is at 1.75 of 4 cores and is no longer the wall, and basemap tiles are 56% of requests for 6% of CPU | [`docs/notes/capacity-ladder-to-1000-users-measured.md`](notes/capacity-ladder-to-1000-users-measured.md) |
