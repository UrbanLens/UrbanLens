...
| P134 | open | 2026-09-21 | At 1,000 users the app tier is CPU-throttled a third of the time while the database uses a quarter of its cores; the navbar is a quarter of every page | [`docs/PROBLEMS.md`](PROBLEMS.md) |
