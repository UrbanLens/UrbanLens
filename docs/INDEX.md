...
**Next free id:** `P111` · `T3` · `PL8` · `D13` · `X16` · `I5` · `R29` · `N21`
...
| X15 | holds | 2026-09-10 | The first neighbour run: one user's ordinary actions multiply another user's latency by up to 39x | [`docs/notes/first-neighbour-run.md`](notes/first-neighbour-run.md) |
