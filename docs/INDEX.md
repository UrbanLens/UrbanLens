...
| P125 | open | 2026-09-19 | The population capacity harness collapses on the app container's CPU - at 200 concurrent users once the map's tiles are in the model, 250 without them; production's 4-core override is still undeployed and unmeasured | [`docs/PROBLEMS.md`](PROBLEMS.md) |
