...
| P134 | partial | 2026-09-21 | The app tier, not the database, is what runs out; caching the navbar's access question moved 500 concurrent users from six budget breaches to none, and the after-ladder is recorded | [`docs/PROBLEMS.md`](PROBLEMS.md) |
