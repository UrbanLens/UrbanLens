...
**Next free id:** `P83` · `T3` · `PL7` · `D6` · `X14` · `I4` · `R27` · `N7`
...
| P11 | open | 2026-09-06 | 99 raw `fetch()` calls bypass `fetch-json.ts`; the three game clients are migrated, the rest are not | [`docs/PROBLEMS.md`](PROBLEMS.md) |
