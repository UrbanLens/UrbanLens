...
| N28 | current | 2026-09-23 | A read of controllers, services, models, tasks, and the map frontend found game-auth, wiki-notify, anonymous geocode, merge-atomicity, login-oracle, pin-share race, undo-without-recheck, and profile-preview-scope defects, plus copied game and bulk-pin code; no fixes proposed | [`docs/notes/codebase-assessment-2026-09-23.md`](notes/codebase-assessment-2026-09-23.md) |
