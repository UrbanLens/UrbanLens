...
| N28 | current | 2026-09-23 | A read of controllers, services, models, tasks, and the map frontend found game-auth, wiki-notify, geocode, merge, login-oracle, pin-share, undo, profile-preview, trip-list, billing-race, friend-cap, and media-buffer defects; no fixes proposed | [`docs/notes/codebase-assessment-2026-09-23.md`](notes/codebase-assessment-2026-09-23.md) |
